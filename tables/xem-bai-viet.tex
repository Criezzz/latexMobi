...
{\makeatletter
 ...
 \def\@captype{a@table}
 \def\@captiontext{\centering Bảng kiểm thử: Xem bài viết}
...
\hline
6 & Xem bài viết đã bị xóa & Bài viết có title, body, tag, có 1 ảnh. Chủ bài viết xóa bài viết trong khi tester đang xem chi tiết bài viết và thực hiện thao tác kéo xuống làm mới & Hiển thị snackbar ``Không tìm thấy bài viết'' & Như mong đợi & Pass \\
\hline 
